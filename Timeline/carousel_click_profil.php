<?php
    ...
    /*partie pour l'affichage des posts du profil visité*/
 ...
 /* Carousel avec texte à droite + petites images en dessous */
     ...
     function carousel_ses_posts($tabPhotos)
     {

         $photos = getPathSesPosts($tabPhotos);
    ...
    /*partie pour l'affichage des identification du profil visité*/
    ...
    function getPathSesIdentifications($tab){
    ...
    function panelSesIdentifications($tab){
     ...
     function carousel_ses_identifications($tabPhotos)
     {

         $photos = getPathSesIdentifications($tabPhotos);
